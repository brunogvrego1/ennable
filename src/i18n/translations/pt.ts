export const pt = {
  ...
  slide01: {
    title: "Ennable",
    subtitle: "O primeiro Sistema Operacional generativo do mundo para comércio",
  ...
  // Slide 05 - Why Now
  slide05: {
    label: "O \"Por Que Agora?\"",
    title: "O Ponto de Inflexão\nGenerativo",
    legacyLabel: "Abordagem Legada",
    legacyTitle: "Lógica Fixa",
    legacyPoints: [
      "Recursos tamanho único",
      "Meses de customização",
      "Consultores caros"
    ],
    ennableLabel: "ABORDAGEM ENNABLE",
    ennableTitle: "Lógica Generativa",
    ennablePoints: [
      "IA cria exatamente o que você precisa",
      "Minutos, não meses",
  ...
  slide07: {
    label: "O Ecossistema",
    title: "Extensibilidade Infinita",
    subtitle: "Ennable é uma plataforma, não apenas uma ferramenta. Mini-apps personalizados criados pela comunidade.",
    appStore: "Loja de Apps Fluid",
    apps: {
      aiSommelier: { name: "Sommelier IA", description: "Recomendações inteligentes de harmonização de vinhos", tag: "IA" },
      loyaltyRewards: { name: "Programa de Fidelidade", description: "Programa de pontos e níveis de fidelidade", tag: "Popular" },
      smsReengagement: { name: "Reengajamento SMS", description: "Campanhas automatizadas de reengajamento", tag: "Marketing" },
      sakePairing: { name: "Harmonização de Sake", description: "Combinação de sake japonês para todos os paladares", tag: "IA" },
      shiftScheduler: { name: "Agenda de Turnos", description: "Agendamento de funcionários e disponibilidade", tag: "Operações" },
      multiLanguage: { name: "Multi-idioma", description: "Tradução automática para hóspedes globais", tag: "Essencial" },
      tableManagement: { name: "Gestão de Mesas", description: "Reservas e assentos inteligentes", tag: "Popular" },
      analyticsDashboard: { name: "Painel de Análises", description: "Insights de negócios em tempo real", tag: "Negócios" },
      splitPayments: { name: "Pagamentos Divididos", description: "Divisão fácil de contas para grupos", tag: "Essencial" },
      menuBuilder: { name: "Construtor de Menu", description: "Criação e atualizações dinâmicas de menu", tag: "Operações" }
    },
    badges: {
      moreApps: "+ Apps",
      buildOwn: "Crie o Seu",
      buildFromExisting: "Crie a Partir de Existentes"
    }
  },
  ...
  slide08: {
    label: "O Fosso",
    title: "Defensibilidade e\nEfeitos de Rede",
    moatTitle: "Fosso Duplo",
    moatPoints: [
      "Compreensão profunda permite Serviços de Crédito e ofertas de seguro",
      "Efeitos de rede da loja de apps criada pela comunidade"
    ],
    switchingCosts: "Uma vez que mini apps suportam necessidades ultra-específicas, custos de mudança se tornam insuperáveis.",
    flywheel: {
      moreUsers: "Mais Usuários",
      moreApps: "Mais Mini-Apps",
      richerData: "Dados Mais Ricos"
    }
  },
  ...
  slide10: {
    ...
    title: "A Zona \"Goldilocks\" de $50B",
    subtitle: "O mercado médio está subatendido—muito complexo para ferramentas SMB, muito ágil para inchaço Enterprise.",
    smallBiz: "Pequenas\nEmpresas",
