export const en = {
  ...
  slide01: {
    title: "Ennable",
    subtitle: "The world's first generative Operating System for commerce",
  ...
  slide05: {
    label: "The \"Why Now?\"",
    title: "The Generative\nInflection Point",
    legacyLabel: "Legacy Approach",
    legacyTitle: "Fixed Logic",
    legacyPoints: [
      "One-size-fits-all features",
      "Months of customization",
      "Expensive consultants"
    ],
    ennableLabel: "ENNABLE APPROACH",
    ennableTitle: "Generative Logic",
    ennablePoints: [
  ...
  slide07: {
    ...
    subtitle: "Ennable is a platform, not just a tool. Purpose-built mini-apps created by the community.",
    appStore: "Fluid App Store",
    apps: {
      aiSommelier: { name: "AI Sommelier", description: "Smart wine pairing recommendations for any dish", tag: "AI-Powered" },
      loyaltyRewards: { name: "Loyalty Rewards", description: "Points & tier-based loyalty program", tag: "Popular" },
      smsReengagement: { name: "SMS Re-engagement", description: "Automated guest re-engagement campaigns", tag: "Marketing" },
      sakePairing: { name: "Sake Pairing", description: "Japanese sake matching for every palate", tag: "AI-Powered" },
      shiftScheduler: { name: "Shift Scheduler", description: "Staff scheduling & availability management", tag: "Operations" },
      multiLanguage: { name: "Multi-language", description: "Auto-translation for global guests", tag: "Essential" },
      tableManagement: { name: "Table Management", description: "Reservations & intelligent seating", tag: "Popular" },
      analyticsDashboard: { name: "Analytics Dashboard", description: "Real-time business insights & trends", tag: "Business" },
      splitPayments: { name: "Split Payments", description: "Easy bill splitting for groups", tag: "Essential" },
      menuBuilder: { name: "Menu Builder", description: "Dynamic menu creation & updates", tag: "Operations" }
    },
    badges: {
      moreApps: "+ Apps",
      buildOwn: "Build Your Own",
      buildFromExisting: "Build From Existing"
    }
  },
  ...
  slide10: {
    ...
    title: "The $50B \"Goldilocks\" Zone",
    subtitle: "The mid-market is underserved—too complex for SMB tools, too nimble for Enterprise bloat.",
    smallBiz: "Small\nBiz",
