...
const apps: AppCardItem[] = [{
  ...
  icon: Wine,
  name: "AI Sommelier",
  description: "Smart wine pairing recommendations for any dish",
  tag: "AI-Powered",
  tagVariant: "cyan"
}, {
  id: 2,
  ...
  description: "Points & tier-based loyalty program",
  tag: "Popular",
  tagVariant: "amber"
}, {
  id: 3,
  ...
  description: "Automated guest re-engagement campaigns",
  tag: "Marketing",
  tagVariant: "green"
}, {
  id: 4,
  icon: Sparkles,
  name: "Sake Pairing",
  description: "Japanese sake matching for every palate",
  tag: "AI-Powered",
  tagVariant: "cyan"
}, {
  id: 5,
  ...
  description: "Staff scheduling & availability management",
  tag: "Operations",
  tagVariant: "blue"
}, {
  id: 6,
  icon: Globe,
  name: "Multi-language",
  description: "Auto-translation for global guests",
  tag: "Essential",
  tagVariant: "purple"
}, {
  id: 7,
  ...
  description: "Reservations & intelligent seating",
  tag: "Popular",
  tagVariant: "amber"
}, {
  id: 8,
  ...
  description: "Real-time business insights & trends",
  tag: "Business",
  tagVariant: "green"
}, {
  id: 9,
  icon: CreditCard,
  name: "Split Payments",
  description: "Easy bill splitting for groups",
  tag: "Essential",
  tagVariant: "purple"
}, {
  id: 10,
  icon: Utensils,
  name: "Menu Builder",
  description: "Dynamic menu creation & updates",
  tag: "Operations",
  tagVariant: "blue"
}];
export const Slide07Ecosystem = () => {
  return <SlideSection id="slide-7">
      <motion.div className="mb-3 sm:mb-4 md:mb-6" variants={itemVariants}>
        <span className="tesla-label">The Ecosystem</span>
        <h2 className="slide-title mt-2">
          Infinite Extensibility
        </h2>
        <p className="slide-subtitle mt-2 max-w-3xl font-light">Ennable is a platform, not just a tool. Purpose-built mini-apps created by the community.</p>
      </motion.div>
