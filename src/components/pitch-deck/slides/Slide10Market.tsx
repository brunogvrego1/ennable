    ...
    <SlideSection id="slide-10">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-80">
          {/* Small Biz blob */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-24 h-24 rounded-full bg-muted/50 border border-border flex items-center justify-center">
            <span className="text-xs text-muted-foreground text-center">Small<br/>Biz</span>
          </div>
          
          {/* Mid-Market blob - highlighted */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <div className="w-48 h-48 rounded-full bg-gradient-to-br from-accent/20 to-coral/20 border-2 border-accent flex items-center justify-center relative">
              <div className="text-center">
                <p className="text-sm text-accent font-medium">Mid-Market</p>
                <p className="text-3xl font-bold mt-1">$50B</p>
          ...
          {/* Enterprise blob */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-32 h-32 rounded-full bg-muted/30 border border-border flex items-center justify-center">
            <span className="text-sm text-muted-foreground text-center">Enterprise</span>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="p-6 bg-card rounded-xl border border-border">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold">$8B</span>
            </div>
          ...
          <div className="p-6 bg-card rounded-xl border border-border">
            <div className="flex items-center justify-between mb-4">
              <span className="text-muted-foreground">Serviceable Addressable Market</span>
